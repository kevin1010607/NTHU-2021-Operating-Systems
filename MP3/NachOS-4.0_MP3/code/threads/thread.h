...
class Thread {
  ...
  public:
    ...
    void setStartAgeTick(int tick) { startAgeTick = tick; }
    void setTotalAgeTick(int tick) { totalAgeTick = tick; }
    double getRemainingBurstTime() { return remainingBurstTime; }
    double getLastExecTime() { return lastExecTime; }
    int getLevel();
    void UpdateAgeTick();
    void UpdatePriority();
    // ********** MP3 ********** //
